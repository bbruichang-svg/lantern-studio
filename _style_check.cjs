...
async function main() {
  ...
  await page.screenshot({ path: OUT + "\\sty_hang.png" })
  log("hang shot")

  // dissolve ~10.7-13.5
  await page.waitForTimeout(3600)
  await page.screenshot({ path: OUT + "\\sty_dissolve.png" })
  log("dissolve shot")

  // memory ~13.5+
  await page.waitForTimeout(3000)
  await page.screenshot({ path: OUT + "\\sty_memory.png" })
  ...
  await page.waitForTimeout(3000)
  await page.screenshot({ path: OUT + "\\sty_share.png" })
  log("share shot")
  ...
  await page.screenshot({ path: OUT + "\\sty_root.png" })
  log("root shot")
