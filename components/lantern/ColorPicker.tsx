        ...
        return (
          <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-full transition-all duration-200 hover:scale-110 ${
              isSelected ? "outline outline-1 outline-offset-2 outline-[#2A2622]" : "outline outline-1 outline-transparent"
            }`}
          >
            <span
              className="block h-7 w-7 rounded-full border border-black/10 transition-shadow duration-[400ms]"
              style={{
